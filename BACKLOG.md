...
- 2026-09-25 · scale · open — Before ~8,000 posts: move hero images to R2 (the contract already accepts `https://` hero URLs) so a deploy stays under the free plan's 20,000 files.
