...
On the Claude Platform, Anthropic lists these rates ([Anthropic](https://www.anthropic.com/claude-opus-5-5)):

| Meter | Opus 5.5 list | vs Opus 5 (Anthropic) |
| --- | --- | --- |
| Input / 1M tokens | **$4** | ~**20%** lower |
| Output / 1M tokens | **$20** | ~**20%** lower |
| Cache reads / 1M tokens | **$0.20** | ~**60%** lower |
...
## Watermarks, safeguards, and early-tester color
